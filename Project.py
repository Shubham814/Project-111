...
def show_fig(meanList):
  ...
  fig.add_trace(go.Scatter(x = [samplingMean,samplingMean],y = [0,1], name = "Mean")) 
  fig.add_trace(go.Scatter(x = [sd1_str,sd1_str],y = [0,0.9], name = "Stdev_1 Start")) 
  fig.add_trace(go.Scatter(x = [sd1_end,sd1_end],y = [0,0.9], name = "Stdev_1 End")) 
  fig.add_trace(go.Scatter(x = [sd2_str,sd2_str],y = [0,0.8], name = "Stdev_2 Start")) 
  fig.add_trace(go.Scatter(x = [sd2_end,sd2_end],y = [0,0.8], name = "Stdev_2 End")) 
  fig.add_trace(go.Scatter(x = [sd3_str,sd3_str],y = [0,0.7], name = "Stdev_3 Start")) 
  fig.add_trace(go.Scatter(x = [sd3_end,sd3_end],y = [0,0.7], name = "Stdev_3 End")) 
